...
top_n_target <- 5
top_n_DISEASE <- 15
filename <- "Kinase_GPCR_circulatory_system_process_Diseases_target_classes_1995-2005_percent.csv"
plot_title <- "Circulatory System Process: 1995-2005"


raw_data <- read_csv(glue::glue("../TimeTrends_Chembl/data_from_knime/Networks/NEW_percent/",filename)) %>% select(-Target_class_Connectivity)
...
g
#ggsave(file = "/Users/barbara/Dropbox/TimeTrendAnalyses/TimeTrends_Chembl/Results/Networks/Network_immune_system_process_P1.tiff", dpi = 300, device = "tiff")
